...
<script lang="ts" src="@/scripts/dashboard/components/list.ts"></script>
                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <el-dropdown trigger="click">
                            ...
                            <template #dropdown>
                                <el-dropdown-menu>
                                    <TimeSelect @timeResult="getTimeSelect" :selectSettings="getTimeSelect" />
                                </el-dropdown-menu>
                            </template>
                        </el-dropdown>
    ...
    <div class="row">
        <div class="col-md-12 col-xl-4">
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mt-0 header-title">{{ t("Most Salling Items") }}</h4>
                        <el-dropdown trigger="click">
                            <el-button class="my-1" type="primary" size="small">
                                <el-icon :size="15" style=" vertical-align: middle; ">
                                    <More />
                ...
                <div class="card-body">
                    ...
                    <el-carousel :interval="4000" type="card" height="200px" class="pt-2">
                        <el-carousel-item v-for="( index) in 4" :key="index">
                            <el-image style="width: 200px; height: 200px" src="" fit="fill" />
                        </el-carousel-item>
                    </el-carousel>
                </div>
            </div>
