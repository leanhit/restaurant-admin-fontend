...
<template>
    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mt-0 header-title">{{ t("Sale overview") }}</h4>
                                            ...
                                            <tr>
                                                <td>
                                                    <el-button class="border-0 mx-1 my-1" size="small"
                                                        ...
                                                        <span class="ml-1">{{ t("Clone Table") }}</span>
                                                    </el-button>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <el-button class="border-0 mx-1 my-1" size="small"
                                                        ...
                                                        <span class="ml-1">{{ t("Edit Table") }}</span>
                                                    </el-button>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <el-button class="border-0 mx-1 my-1" size="small"
                                                        ...
                                                        <span class="ml-1">{{ t("Delete Table") }}</span>
                                                    </el-button>
                                                </td>
                                            </tr>
                                        </tbody>
                ...
                <div class="card-body">
                    <p class="text-muted mb-4 font-14">Bootstrap includes six predefined button styles, each serving its
                        own semantic purpose.</p>
        ...
        <div class="col-md-12 col-xl-5">
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mt-0 header-title">{{ t("Items State") }}</h4>
                        <el-select v-model="saleValue" class="m-2" placeholder="Select" size="small">
                            <el-option v-for="item in SaleOptions" :key="item.value" :label="item.label"
                                :value="item.value" />
                        </el-select>
    ...
    <div class="row">
        <div class="col-md-12 col-xl-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="mt-0 header-title">{{ t("Best sale item") }}</h4>

                    <el-carousel :interval="4000" type="card" height="200px" class="pt-2">
                        <el-carousel-item v-for="(img, index) in 4" :key="index">
                            <el-image style="width: 200px; height: 200px" :src="img" fit="fill" />
                        </el-carousel-item>
                    </el-carousel>
                </div>
            </div>
        ...
        <div class="col-md-12 col-xl-8">
            <div class="card">
                <div class="card-body">
                    <h4 class="mt-0 header-title">{{ t("revenue over month") }}</h4>
                    <p class="text-muted mb-4 font-14">Bootstrap includes six predefined button styles, each serving its
                        own semantic purpose.</p>
